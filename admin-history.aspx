...
>>>>>>> 083a443eb4560d90885db7e786621507b53542b4
              ...
              <asp:SqlDataSource runat="server" ID="SqlDataSource1"
                  ...
                  SelectCommand="SELECT c.[Id], [title], date_registered as date ,  d.[department_name] as dept, [description], [address], [city], [pincode], [photo], [status], [image] FROM [complaints] c join departments d on d.id = c.department WHERE ([department] = @department and status = 'resolved')"
...
>>>>>>> 083a443eb4560d90885db7e786621507b53542b4
              ...
              <asp:SqlDataSource runat="server" ID="SqlDataSource2"
                  ConnectionString='<%$ ConnectionStrings:Complaint_dbConnectionString %>' 
                  SelectCommand="SELECT c.[Id], [title],  date_registered as date  , d.[department_name] as dept, [description], [address], [city], [pincode], [photo], [status], [image] FROM [complaints] c join departments d on d.id = c.department WHERE ([department] = @department and status = 'rejected')"
                  DeleteCommand="delete from  complaints where id = @id">
                  <SelectParameters>
                      <asp:SessionParameter SessionField="department" Name="department" Type="Int32"></asp:SessionParameter>
                  </SelectParameters>
