<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manage-complaint.aspx.cs" Inherits="ComplaintManagement.manage_complaint" %>
        ...
        <main class="p-5">
          ...
          <div>
            <h3>New Complaints</h3>
              ...
              <asp:GridView AllowSorting="true" AllowPaging="true" ID="gvNewComplaints" class="table table-striped row"  DataKeyNames="id" runat="server" AutoGenerateColumns="False" DataSourceID="sqlDataSource1"   >
                  <Columns>
<<<<<<< HEAD
...
>>>>>>> 083a443eb4560d90885db7e786621507b53542b4
              ...
              <asp:SqlDataSource runat="server" ID="SqlDataSource1"
                  ...
                  SelectCommand="SELECT c.[Id], cast (date_registered as date) as date ,  [title], d.[department_name] as dept, [description], [address], [city], [pincode], [photo], [status], [image] FROM [complaints] c join departments d on  c.department = d.id WHERE ([department] = @department and status = 'new')"
...
<asp:TemplateField HeaderText="Image" >
              ...
              <asp:SqlDataSource runat="server" ID="SqlDataSource2"
                  ConnectionString='<%$ ConnectionStrings:Complaint_dbConnectionString %>' 
                  SelectCommand="SELECT c.[Id], [title], date_registered as date ,  d.[department_name] as dept, [description], [address], [city], [pincode], [photo], [status], [image] FROM [complaints] c join departments d on d.id  = c.department WHERE ([department] = @department and status = 'ongoing')"
                  UpdateCommand="update complaints set status = @status
where id = @id">
                  <SelectParameters>
                      <asp:SessionParameter SessionField="department" Name="department" Type="Int32"></asp:SessionParameter>
