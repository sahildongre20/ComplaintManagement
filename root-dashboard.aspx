...
<body>
    ...
    <nav class="navbar bg-dark text-light">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="admin-dashboard.aspx" class="nav-link">
          ...
          <li class="nav-item">
            <a href="manage-complaint.aspx" class="nav-link">
          ...
          <li class="nav-item">
            <a href="admin-history.aspx" class="nav-link">
        ...
        <main class="p-5">
          ...
          <div>
            <div class="container shadow p-3 mb-5  rounded bg-body row">
              <div class="col-md">
                <div class="card p-3 shadow p-3 my-3 bg-dark rounded text-light" data-bs-toggle="tooltip" data-bs-placement="top" title="New complent that are not accepted by department">
                  
             <h2>New Complaints</h2>
                   <p class="lead"><asp:Label ID="lbl_new" runat="server"></asp:Label></p>
                </div>
              </div>
              <div class="col-md">
                <div class="card p-3 shadow p-3  my-3 bg-dark rounded text-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Complent that are  accepted and are under process">
                  <h2>Ongoing Complaints</h2>
                    <p class="lead"><asp:Label ID="lbl_ongoing" runat="server"></asp:Label></p> 
                </div>
              </div>
              <div class="col-md">
                <div class="card p-3 shadow p-3 my-3 bg-dark rounded text-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Past complent that are Resolved">
                  <h2>Resolved Complaints</h2> 
                    <p class="lead"><asp:Label ID="lbl_resolved" runat="server"></asp:Label></p>
                </div>
              </div>
              <div class="col-md">
              <div class="card p-3  shadow p-3 my-3 bg-dark rounded text-light"data-bs-toggle="tooltip" data-bs-placement="top" title="Complent that are not accepted by department due to insufficient information">
               <h2>Rejected Complaints</h2> 
                  <p class="lead"><asp:Label ID="lbl_rejected" runat="server"></asp:Label>
                   </p>
               </div>
              </div>
              <div class="col-md">
                <div class="card p-3 shadow p-3 my-3 bg-dark  rounded text-light"data-bs-toggle="tooltip" data-bs-placement="top" title="All complaints ">
                  <h2>Total Complaints</h2> 
                    <p class="lead"><asp:Label ID="lbl_total" runat="server"></asp:Label>
                       </p>
                </div>
              </div>
            </div>
            ...
            <h3> Pie Chart</h3>
                    ...
                    <asp:Chart ID="Chart1" runat="server" DataSourceId="SqlDataSource1">
                        <Series>
                            <asp:Series Name="Series1" ChartType="Pie" XValueMember="status" YValueMembers="total" IsValueShownAsLabel="True" Legend="Legend1"></asp:Series>
                        </Series>
                        <ChartAreas>
